  ...
  const handleCurrencyBSelect = useCallback(
    (currencyB_: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        router.replace(`/add/${currencyIdA || 'ETHW'}/${newCurrencyIdB}`, undefined, { shallow: true })
      }
    },
    ...
    <Page>
        ...
        <CardBody>
          <AutoColumn gap="20px">
            ...
            {currencies[Field.CURRENCY_A] && currencies[Field.CURRENCY_B] && pairState !== PairState.INVALID && (
              <>
                <LightCard padding="0px" borderRadius="20px" style={{borderRadius:'12px',background:'#111217',border:'none'}}>
                  <RowBetween padding="1rem" >
                    <Text fontSize="14px">
                      {noLiquidity ? t('Initial prices and pool share') : t('Prices and pool share')}
                    </Text>
                  </RowBetween>{' '}
                  <LightCard padding="1rem" borderRadius="0 0 15px 15px" style={{border:'none',background:'#1e2028'}}>
                    <PoolPriceBar
                      currencies={currencies}
                      poolTokenPercentage={poolTokenPercentage}
                      noLiquidity={noLiquidity}
      ...
      {!addIsUnsupported ? (
        pair && !noLiquidity && pairState !== PairState.INVALID ? (
          <AutoColumn style={{ minWidth: '20rem', width: '100%', maxWidth: '440px', marginTop: '1rem' }}>
            <MinimalPositionCard showUnwrapped={oneCurrencyIsWETH} pair={pair} style={{border:'none',background:'#111218'}}/>
          </AutoColumn>
        ) : null
      ) : (
