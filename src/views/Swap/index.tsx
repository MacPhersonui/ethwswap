...
const SwitchIconButton = styled(IconButton)`
  ...
  background: linear-gradient(270deg,#936CE7 0%,#3AD1A8 100%);
  border-radius: 50%;
  width: 24px;
  height: 24px;
  .icon-up-down {
    ...
    <Page removePadding={isChartExpanded} hideFooterOnDesktop={isChartExpanded}>
      <Flex width="100%" justifyContent="center" position="relative">
        ...
        <Flex flexDirection="column" >
          <StyledSwapContainer $isChartExpanded={isChartExpanded}  style={{borderRadius:'0px 25px 0 0'}}>
            <StyledInputCurrencyWrapper mt={isChartExpanded ? '24px' : '0'} style={{width:'390px', padding: '0 20px'}} >
              <AppBody >
                <CurrencyInputHeader 
                  title={t('Swap')}
                ...
                />
                <Wrapper id="swap-page" style={{ minHeight: '412px', background: '#26252f', borderBottomLeftRadius: "12px", borderBottomRightRadius: "12px",padding:'0'}}>
                  <AutoColumn gap="0" style={{margin:'15px'}}>
                    <CurrencyInputPanel
                      label={
                  ...
                  <Box mt="0.25rem">
                    {swapIsUnsupported ? (
                      ...
                      <ConnectWalletButton width="100%" style={{ background: "#797DFF",borderRadius:'0 0 12px 12px' }} />
                    ) : showWrap ? (
                      ...
                      <Button style={{borderRadius:'0px 0px 12px 12px'}}
