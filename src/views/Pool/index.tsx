...
export default function Pool() {
  ...
  const renderBody = () => {
    ...
    return (
      <Text color="textSubtle" textAlign="center" style={{color:'#35284e'}}>
  ...
  return (
    <Page>
      <AppBody>
        ...
        <Body>
          ...
          {account && !v2IsLoading && (
            <Flex flexDirection="column" alignItems="center" mt="24px">
              <Text color="textSubtle" mb="8px" style={{color:'#35284e'}}>
        ...
        <CardFooter style={{ textAlign: 'center' ,padding:'0px'}}>
          <Link href="/add" passHref>
            <Button style={{borderRadius:'0px 0px 25px 25px',height:'55px'}} id="join-pool-button" width="100%" startIcon={<AddIcon color="white" />}>
              {t('Add Liquidity')}
            </Button>
          </Link>
        </CardFooter>
