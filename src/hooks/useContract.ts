...
function useContract<T extends Contract = Contract>(
  ...
  return useMemo(() => {
    ...
    try {
      console.log("useMemo", address, ABI, withSignerIfPossible ? getProviderOrSigner(library, account) : null)
...
export function useWETHContract(withSignerIfPossible?: boolean): Contract | null {
  ...
  console.log("WETH",useContract<Weth>(chainId ? WETH[chainId].address : undefined, WETH_ABI, withSignerIfPossible))
